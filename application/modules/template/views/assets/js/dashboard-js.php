...
<script src="<?= base_url() ?>material-dashboard-2-pro/assets/js/plugins/chartjs.min.js"></script>
<script src="<?= base_url() ?>material-dashboard-2-pro/assets/js/plugins/world.js"></script>
<script>
